...
Blockly.CSharp['lists_repeat'] = function(block) {
  ...
  var functionName = Blockly.CSharp.provideFunction_(
      ...
      ['function ' + Blockly.CSharp.FUNCTION_NAME_PLACEHOLDER_ +
       ...
       '  return array;',
       '}']);
  var element = Blockly.CSharp.valueToCode(block, 'ITEM',
      Blockly.CSharp.ORDER_NONE) || 'null';
  var repeatCount = Blockly.CSharp.valueToCode(block, 'NUM',
...
Blockly.CSharp['lists_length'] = function(block) {
  ...
  return [list + '.length', Blockly.CSharp.ORDER_MEMBER];
};
...
Blockly.CSharp['lists_isEmpty'] = function(block) {
  ...
  var list = Blockly.CSharp.valueToCode(block, 'VALUE',
      Blockly.CSharp.ORDER_MEMBER) || '[]';
  return ['!' + list + '.length', Blockly.CSharp.ORDER_LOGICAL_NOT];
};
...
Blockly.CSharp['lists_indexOf'] = function(block) {
  ...
  var operator = block.getFieldValue('END') == 'FIRST' ?
      'indexOf' : 'lastIndexOf';
  var item = Blockly.CSharp.valueToCode(block, 'FIND',
...
Blockly.CSharp['lists_getIndex'] = function(block) {
  ...
  var listOrder = (where == 'RANDOM') ? Blockly.CSharp.ORDER_NONE :
      Blockly.CSharp.ORDER_MEMBER;
  var list = Blockly.CSharp.valueToCode(block, 'VALUE', listOrder) || '[]';
...
Blockly.CSharp['lists_setIndex'] = function(block) {
  ...
  function cacheList() {
    ...
    var listVar = Blockly.CSharp.nameDB_.getDistinctName(
  ...
  switch (where) {
    ...
    case ('FROM_START'):
      ...
      break;
    case ('FROM_END'):
      var at = Blockly.CSharp.getAdjusted(block, 'AT', 1, false,
    ...
    case ('RANDOM'):
      var code = cacheList();
      var xVar = Blockly.CSharp.nameDB_.getDistinctName(
 ...
 * @private
 */
Blockly.CSharp.lists_getIndex = function(listName, where, opt_at) {
  if (where == 'FIRST') {
    return '0';
...
Blockly.CSharp['lists_getSublist'] = function(block) {
  ...
  if (where1 == 'FIRST' && where2 == 'LAST') {
    ...
    var getIndex_ = Blockly.CSharp.lists.getIndex_;
...
Blockly.CSharp['lists_split'] = function(block) {
  ...
  var input = Blockly.CSharp.valueToCode(block, 'INPUT',
      Blockly.CSharp.ORDER_MEMBER);
  var delimiter = Blockly.CSharp.valueToCode(block, 'DELIM',
      Blockly.CSharp.ORDER_NONE) || '\'\'';
...
Blockly.CSharp['lists_reverse'] = function(block) {
